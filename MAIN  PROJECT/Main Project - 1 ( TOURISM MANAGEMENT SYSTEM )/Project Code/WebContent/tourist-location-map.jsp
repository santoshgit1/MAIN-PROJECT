...
<body>
	...
	<div id="floating-panel">
		<b>Start: </b> <select id="start">
			<option value="ahmednagar, il">Ahmednagar</option>
		</select> <b>End: </b> <select id="end" onchange="calculateAndDisplayRoute()">
			<option value="pune il">Chicago</option>
		</select>
	</div>
	<div id="map"></div>
	<script>
	...
	<script async defer
		src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDH8MwpX0avskvKdyhged-6l3zt8CpESYo&callback=initMap">
